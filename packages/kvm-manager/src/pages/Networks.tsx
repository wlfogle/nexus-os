...
export default function Networks() {
 ...
 <div key={network.uuid} className="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700">
 <div className="p-6">
 ...
 network.state === 'active' ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300' : 'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300'
 }`}>
 {network.state}
 </span>
 </div>
 ...
 <span className="ml-1 text-gray-900 dark:text-white">{network.connected_vms.length}</span>
 </div>

 <div className="text-xs text-gray-500 dark:text-gray-400">UUID: {network.uuid}</div>
 </div>
 </div>
 ))}
 </div>
