...
.PHONY: userland
userland: $(USERLAND_BUILD)/libc.a $(USERLAND_BUILD)/init.elf $(USERLAND_BUILD)/bin/echo.elf $(USERLAND_BUILD)/bin/cat.elf $(USERLAND_BUILD)/bin/ps.elf $(USERLAND_BUILD)/bin/shell.elf $(USERLAND_BUILD)/bin/netstat.elf $(USERLAND_BUILD)/bin/ifconfig.elf $(USERLAND_BUILD)/bin/nettest.elf $(USERLAND_BUILD)/bin/threadtest.elf
