...
class OllamaCodeCheckerGUI:
    ...
    def load_available_models(self):
        ...
        models_path = os.environ.get('OLLAMA_MODELS', '/media/loufogle/73cf9511-0af0-4ac4-9d83-ee21eb17ff5d/models')
    ...
    def run_analysis(self):
        ...
        try:
            ...
            # Run the analysis
            env = os.environ.copy()
            env['OLLAMA_MODELS'] = os.environ.get('OLLAMA_MODELS', '/media/loufogle/73cf9511-0af0-4ac4-9d83-ee21eb17ff5d/models')
