...
class USBCreationDialog(Adw.Window):
    ...
    def __init__(self, parent, iso_path):
        ...
        self.set_modal(True)
        self.set_title("Create Bootable USB Drive")
    ...
    def setup_ui(self):
        ...
        self.create_button = Gtk.Button(label="Create USB")
        self.create_button.add_css_class("destructive-action")
        self.create_button.set_sensitive(False)
        self.create_button.connect('clicked', lambda b: self.start_usb_creation())
    ...
    def show_error(self, message):
        ...
        print(f"USB Creation Error: {message}")
        self.close()
