...
> **NexusOS status:** TARGET OPERATING SYSTEM  
> Primary monorepo for the AI-driven OS. Other repos are component source, platform research, historical reference, or separate tools feeding this OS.  
> Preserve working source code. Delete only generated/vendor artifacts or stale operational configs with no unique logic.
...
NexusOS is the target operating system for the broader `wlfogle` repo geoscape.
See `docs/COMPONENT-INVENTORY.md` for how `bulletproof-mediastack`,
`mobalivecd-linux`, terminal/admin apps, installer experiments, media-stack
repos, and hardware-support TODOs map into NexusOS.
